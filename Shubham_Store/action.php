				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com" method="post">
							...
							<input type="hidden" name="business" value="shoppingcart@Shubhamstore.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/Shubham_Store/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/Shubham_Store/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/Shubham_Store/cancel.php"/>
